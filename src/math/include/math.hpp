...
namespace Math
{
    ...
    void MatMulNWN(double beta, Pointer<double> m_o, double alpha, Pointer<double> mL_i, Pointer<double> mR_i, Pointer<double> w_i, int M, int K, int N, Type type);
    ...
    void MatMulNWT(double beta, Pointer<double> m_o, double alpha, Pointer<double> mL_i, Pointer<double> mR_i, Pointer<double> w_i, int M, int K, int N, Type type);
    ...
    void MatMulTWN(double beta, Pointer<double> m_o, double alpha, Pointer<double> mL_i, Pointer<double> mR_i, Pointer<double> w_i, int M, int K, int N, Type type);
    ...
    void MatMulTWT(double beta, Pointer<double> m_o, double alpha, Pointer<double> mL_i, Pointer<double> mR_i, Pointer<double> w_i, int M, int K, int N, Type type);
